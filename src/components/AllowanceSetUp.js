  ...
  return (
    <div>
      ...
      <div className="allowanceSetUp" style={{ float: 'left' }}>
        Each day you&apos;ll be given this amount to spend. If you spend too
        much, it&apos;s taken out of tomorrow&apos;s budget. If you don&apos;t
        spend it all, what is left rolls over!
      </div>
    </div>
  )
}
